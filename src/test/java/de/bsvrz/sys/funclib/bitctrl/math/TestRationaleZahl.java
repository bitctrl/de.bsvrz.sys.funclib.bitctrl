...
public class TestRationaleZahl {
	...
	public void testFloatValue() {
		assertEquals(0.25f, a.floatValue(), 0);
		assertEquals(0.625f, b.floatValue(), 0);
	}
	...
	public void testDoubleValue() {
		assertEquals(0.25, a.doubleValue(), 0);
		assertEquals(0.625, b.doubleValue(), 0);
	}
	...
	public void testPotenz() {
		...
		r = new RationaleZahl(1, 16);
		assertEquals(r, RationaleZahl.potenz(a, 2));

		r = new RationaleZahl(125, 512);
		assertEquals(r, RationaleZahl.potenz(b, 3));
	}
