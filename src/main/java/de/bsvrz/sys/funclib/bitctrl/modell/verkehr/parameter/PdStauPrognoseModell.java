 ...
 */
public class PdStauPrognoseModell
extends AbstractParameterDatensatz<PdStauPrognoseModell.Daten> {
	...
	public static class Daten extends AbstractDatum {
		 ...
		 */
		public void setDaempfungsZeit(final long daempfungsZeit) {
		 ...
		 */
		public void setPrognoseHorizont(final long prognoseHorizont) {
	 ...
	 */
	public PdStauPrognoseModell(final SystemObjekt objekt) {
		super(objekt);
	...
	protected Data konvertiere(final Daten datum) {
		...
		daten.getTimeValue(Att.PROGNOSE_HORIZONT)
		.setMillis(datum.getPrognoseHorizont());
		...
		daten.getTimeValue(Att.DAEMPFUNGSZEIT)
		.setMillis(datum.getDaempfungsZeit());
