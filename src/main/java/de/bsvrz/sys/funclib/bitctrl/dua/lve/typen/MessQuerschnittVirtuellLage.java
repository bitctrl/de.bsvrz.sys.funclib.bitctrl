...
public final class MessQuerschnittVirtuellLage extends AbstractDavZustand {
	 ...
	 * Wert <code>Vor</code>.
	 */
	public static final MessQuerschnittVirtuellLage VOR = new MessQuerschnittVirtuellLage(
			"Vor", 0); //$NON-NLS-1$

	/**
	 * Wert <code>Mitte</code>.
	 */
	public static final MessQuerschnittVirtuellLage MITTE = new MessQuerschnittVirtuellLage(
			"Mitte", 1); //$NON-NLS-1$

	/**
	 * Wert <code>Nach</code>.
	 */
	public static final MessQuerschnittVirtuellLage NACH = new MessQuerschnittVirtuellLage(
			"Nach", 2); //$NON-NLS-1$

	/**
	 * Wert <code>Ausfahrt</code>.
	 */
	public static final MessQuerschnittVirtuellLage AUSFAHRT = new MessQuerschnittVirtuellLage(
			"Ausfahrt", 3); //$NON-NLS-1$

	/**
	 * Wert <code>Einfahrt</code>.
	 */
	public static final MessQuerschnittVirtuellLage EINFAHRT = new MessQuerschnittVirtuellLage(
			"Einfahrt", 4); //$NON-NLS-1$
