...
/**
 * Fasst alle Objekttypen im Systemmodell AOE zusammen.
 *
 * @author BitCtrl Systems GmbH, Schumann
 */
public enum SystemModellAoeTypen implements SystemObjektTyp {

	/** Die AutarkeOrganisationsEinheit. */
	AUTARKE_ORGANISATIONS_EINHEIT("typ.autarkeOrganisationsEinheit",
			AutarkeOrganisationsEinheit.class);
	 ...
	 */
	private SystemModellAoeTypen(final String pid,
