...
public class Benutzer extends AbstractSystemObjekt {
	...
	public static Benutzer anlegen(final String pid, final String name,
		...
		daten.getTextValue("zweiterVorname")
		.setText(zweiterVorname != null ? zweiterVorname : "");
		daten.getTextValue("nachname")
		.setText(nachname != null ? nachname : "");
		daten.getTextValue("organisation")
		.setText(organisation != null ? organisation : "");
		daten.getTextValue("emailAdresse")
		.setText(emailAdresse != null ? emailAdresse : "");
	...
	private boolean konfigDatenGelesen;
