...
public class SegmentBetriebsKilometer {
	 ...
	 *             existieren
	 */
	public SegmentBetriebsKilometer(final Strasse strasse,
			final FahrtRichtung fahrtRichtung, final StrassenSegment segment)
					throws NetzReferenzException {
		super();
		...
		for (final StrassenTeilSegment teilsegment : segment
			...
			for (final BetriebsKilometer betriebskilometer : teilsegment
	...
	public StrasseUndBetriebsKilometerOrtsReferenz findeBetriebsKilometerAmOffset(
		...
		return new StrasseUndBetriebsKilometerOrtsReferenz(strasse,
				fahrtRichtung, (long) ((vor.getBetriebsKilometer() + offset)
						- vor.getSegmentOffset()),
				vor.getBlockNummer());
	}
}
