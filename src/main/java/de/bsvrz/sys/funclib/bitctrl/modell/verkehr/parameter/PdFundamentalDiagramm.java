 ...
 */
public class PdFundamentalDiagramm
extends AbstractParameterDatensatz<PdFundamentalDiagramm.Daten> {
	...
	public static class Daten extends AbstractDatum {
		 ...
		 *            the k0 to set
		 */
		public void setK0(final Short k0) {
			this.k0 = k0;
		}
		 ...
		 *            the q0 to set
		 */
		public void setQ0(final Integer q0) {
			this.q0 = q0;
		}
		 ...
		 *            the v0 to set
		 */
		public void setV0(final Short v0) {
			this.v0 = v0;
		}
		 ...
		 *            the vFrei to set
		 */
		public void setVFrei(final Short frei) {
			vFrei = frei;
		}
	}
