...
public final class Umrechung {
	...
	public static Double getQB(final Double qLkw, final Double qKfz,
			final Double vPkw, final Double vLkw, final float k1,
			final float k2) {
		Double qb;

		qb = null;
		if ((vPkw != null) && (qLkw != null) && (vLkw != null)
				&& (qKfz != null)) {
			assert qKfz >= qLkw;
	...
	public static Double getVKfz(final Double qLkw, final Double qKfz,
		...
		} else if ((qKfz != null) && (vPkw != null) && (qLkw != null)
				&& (qLkw == 0)) {
			assert vLkw == null;
			vKfz = vPkw;
		} else if ((qKfz != null) && (qLkw != null) && (qLkw > 0)
				&& (vLkw != null)) {
			assert vPkw == null;
			vKfz = vLkw;
		}
