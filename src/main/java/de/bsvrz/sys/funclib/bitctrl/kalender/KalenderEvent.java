...
public class KalenderEvent extends EventObject {
	 ...
	 */
	public KalenderEvent(final Object source, final String absenderZeichen,
			final boolean aenderung,
			final List<OdEreignisKalenderAntwort.Daten.Zustandswechsel> zustandswechsel) {
		super(source);
