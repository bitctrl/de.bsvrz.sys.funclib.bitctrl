...
public final class MessQuerschnittTyp extends AbstractDavZustand {
	 ...
	 */
	private static Map<Integer, MessQuerschnittTyp> werteBereich = new HashMap<Integer, MessQuerschnittTyp>();

	/**
	 * Wert <code>SonstigeFahrbahn</code>.
	 */
	public static final MessQuerschnittTyp SONSTIGE = new MessQuerschnittTyp(
			"SonstigeFahrbahn", 0); //$NON-NLS-1$

	/**
	 * Wert <code>HauptFahrbahn</code>.
	 */
	public static final MessQuerschnittTyp HAUPT = new MessQuerschnittTyp(
			"HauptFahrbahn", 1); //$NON-NLS-1$

	/**
	 * Wert <code>NebenFahrbahn</code>.
	 */
	public static final MessQuerschnittTyp NEBEN = new MessQuerschnittTyp(
			"NebenFahrbahn", 2); //$NON-NLS-1$

	/**
	 * Wert <code>Einfahrt</code>.
	 */
	public static final MessQuerschnittTyp EINFAHRT = new MessQuerschnittTyp(
			"Einfahrt", 3); //$NON-NLS-1$

	/**
	 * Wert <code>Ausfahrt</code>.
	 */
	public static final MessQuerschnittTyp AUSFAHRT = new MessQuerschnittTyp(
			"Ausfahrt", 4); //$NON-NLS-1$
