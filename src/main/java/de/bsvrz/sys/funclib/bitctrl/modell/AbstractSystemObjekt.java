...
public abstract class AbstractSystemObjekt implements SystemObjekt {
	...
	protected AbstractSystemObjekt(final SystemObject obj) {
		objekt = obj;
		parameter = Collections.synchronizedMap(
				new HashMap<Class<? extends ParameterDatensatz<? extends Datum>>, ParameterDatensatz<? extends Datum>>());
		onlineDaten = Collections.synchronizedMap(
				new HashMap<Class<? extends OnlineDatensatz<? extends Datum>>, OnlineDatensatz<? extends Datum>>());
