...
public final class FahrStreifenLage extends AbstractDavZustand {
	...
	public FahrStreifenLage getLinksVonHier() {
		...
		if (this.equals(HFS)) {
			ergebnis = UFS1;
		} else if (this.equals(UFS1)) {
			ergebnis = UFS2;
		} else if (this.equals(UFS2)) {
			ergebnis = UFS3;
		} else if (this.equals(UFS3)) {
			ergebnis = UFS4;
		} else if (this.equals(UFS4)) {
			ergebnis = UFS5;
		} else if (this.equals(UFS5)) {
			ergebnis = UFS6;
		}
	 ...
	 * mit dem übergebenen Code
	 */
	public static FahrStreifenLage getZustand(int code) {
