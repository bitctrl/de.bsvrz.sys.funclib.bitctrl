...
extends AbstractSystemObjekt{
	...
	throws DUAInitialisierungsException{
		...
		if(eigenschaften == null){
			...
			if(eigenschaften.getReferenceValue("Prüfling") != null){ //$NON-NLS-1$
				this.pruefling = eigenschaften.getReferenceValue("Prüfling").getSystemObject(); //$NON-NLS-1$
			}
		}
	}
	...
	/**
	 * Initialisiert diese Klasse, indem für alle Systemobjekte vom Typ <code>typ.messStelle</code>
