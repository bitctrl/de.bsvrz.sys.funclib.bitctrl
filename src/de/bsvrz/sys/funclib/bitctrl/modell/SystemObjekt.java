...
public interface SystemObjekt {
	...
	// /**
	// * Gibt den Konfigurationsbereich zur&uuml;ck in sich das Systemobjekt
	// * befindet.
	// *
	// * @see
	// stauma.dav.configuration.interfaces.SystemObject#getConfigurationArea()
	// * @return Der Konfigurationsbereich
	// */
	// ConfigurationArea getKonfigurationsbereich();
