 ...
 * @version $Id$
 */
public class PdBenutzerParameter extends
		AbstractParameterDatensatz<PdBenutzerParameter.Daten> {
	...
	public void setDaten(final ResultData datensatz) {
		...
		if (datensatz.hasData()) {
			...
			datum.setBerechtigungsklasse((Berechtigungsklasse) factory
					.getModellobjekt(daten.getReferenceValue(
							"berechtigungsklasse").getSystemObject()));
		}
