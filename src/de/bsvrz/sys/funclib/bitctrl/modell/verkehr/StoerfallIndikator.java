...
public class StoerfallIndikator extends AbstractSystemObjekt {
	...
	/**
	 * Erzeugt einen Stˆrfallindikator aus einem Systemobjekt.
	 * 
	 * @param obj
	 *            Ein Systemobjekt, welches ein StˆrfallIndikator sein muss
	...
	public StoerfallIndikator(SystemObject obj) {
		...
		if (!obj.isOfType(getTyp().getPid())) {
			throw new IllegalArgumentException(
					"Systemobjekt ist kein Stˆrfallindikator.");
		}
	...
	/**
	 * setzt den Situationswert f¸r den angegebenen Aspekt.
	 * 
	 * @param situation
	 * @param aspekt
	 */
	 ...
	 * 
	 * @param aspekte
	 *            die Liste der unterst¸tzten Verfahren.
	 */
