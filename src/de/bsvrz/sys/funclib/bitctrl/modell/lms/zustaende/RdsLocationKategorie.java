...
public enum RdsLocationKategorie implements Zustand {

	GEBIET("Gebiet", 1), PUNKT("bedeutender Punkt", 2), LINIE("Linie", 3), SEGMENT(
			"Segment", 4);
	...
	public static RdsLocationKategorie getStatus(final int gesuchterCode) {
		RdsLocationKategorie result = RdsLocationKategorie.PUNKT;
