...
public final class RdsEreignisCode implements Zustand<Integer> {
	...
	private static final Map<Integer, RdsEreignisCode> TABELLE_PER_CODE = new HashMap<Integer, RdsEreignisCode>();

	/** der Menge der Locationtabellen geordnet nach dem Name. */
	private static final Map<String, RdsEreignisCode> TABELLE_PER_NAME = new HashMap<String, RdsEreignisCode>();
