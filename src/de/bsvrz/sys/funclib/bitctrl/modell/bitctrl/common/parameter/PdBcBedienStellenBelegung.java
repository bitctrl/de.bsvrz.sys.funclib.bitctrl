 ...
 * @version $Id$
 */
public class PdBcBedienStellenBelegung extends
		AbstractParameterDatensatz<PdBcBedienStellenBelegung.Daten> {
	...
	protected Data konvertiere(final Daten datum) {
		...
		for (int i = 0; i < mitglieder.getLength(); ++i) {
			mitglieder.getItem(i).asReferenceValue().setSystemObject(
					datum.get(i).getSystemObject());
		}
