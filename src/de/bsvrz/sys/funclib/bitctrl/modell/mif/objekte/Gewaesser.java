...
package de.bsvrz.sys.funclib.bitctrl.modell.mif.objekte;
...
/**
 * Repr‰sentation eine Objekts vom Typ "typ.Gew‰sser" innerhalb der
 * Datenverteilerkonfiguration.
 * 
 * @author BitCtrl Systems GmbH, Uwe Peuker
 * @version $Id$
 */
public class Gewaesser extends KomplexXYImpl {
	 ...
	 * {@inheritDoc}.<br>
	 * 
	 * @see de.bsvrz.sys.funclib.bitctrl.modell.geo.objekte.KomplexXYImpl#getTyp()
	 */
	@Override
	public SystemObjektTyp getTyp() {
		return MifModellTypen.GEWAESSER;
	}
}
